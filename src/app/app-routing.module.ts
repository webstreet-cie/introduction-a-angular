...
const routes: Routes = [
  {path: '', redirectTo: 'fr', pathMatch: 'full'},
    ...
    { path: 'fr/formations/:titre-formation', component: TrainingDetailComponent },
    {path: 'fr/sessions', component:SessionListComponent},
    {path:'fr/sessions/:titre-session', component:SessionDetailComponent},
    {path:'fr/blog',component:BlogListComponent},
    {path:'fr/blog/:titre-article',component:BlogDetailComponent},
    ...
    {path:'formations/modifier/:id-formation', component:AdminTrainingUpdateComponent},
    {path:'sessions', component:AdminSessionListComponent},
    {path:'sessions/creer', component:AdminSessionCreateComponent},
    {path:'sessions/modifier/id:session', component:AdminSessionUpdateComponent},
    ...
    {path:'blog/modifier/:id-article', component:AdminBlogUpdateComponent},
    ...
    {path:'utilisateurs/modifier/:id-utilisateur', component:UserUpdateComponent},
    {path:'utilisateurs/voir/:id-utilisateur', component:UserDetailComponent},

    {path:'categories', component:CategoryListComponent},
    {path:'categories/creer', component:CategoryCreateComponent},
    {path:'categories/modifier/:id-categorie', component:CategoryUpdateComponent},

    {path:'niveaux', component:LevelListComponent},
    {path:'niveaux/creer', component:LevelCreateComponent},
    {path:'niveaux/modifier/:id-niveau', component:LevelUpdateComponent},

    {path:'modalites', component:ModalityListComponent},
    {path:'modalites/creer', component:ModalityCreateComponent},
    {path:'modalites/modifier/:id-modalite', component:ModalityUpdateComponent},

    {path:'competences', component:SkillListComponent},
    {path:'competences/creer', component:SkillCreateComponent},
    {path:'competences/modifier/:id-modalite', component:SkillUpdateComponent},
    ...
    {path:'facture/id:facture', component:InvoiceDetailComponent}
